  ...
  Widget build(BuildContext context) {
    ...
    Widget accountInfo(Account acc, String type, bool following) {
      Map<String, dynamic> colors = {
        "Company": blue.shade600,
        "Student": green.shade400,
        "College": purple.shade400
      };
      Map<String, dynamic> pageRoutes = {
        "Student": "user",
        "Company": "company",
        "College": "college"
      };
      return GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
              boxShadow: [
                BoxShadow(
                    color: white.shade500.withOpacity(0.25),
                    blurRadius: 8,
              ...
              image: acc.pfp.isNotEmpty
                  ? DecorationImage(
                      ...
                      colorFilter: ColorFilter.mode(
                          white.shade900.withOpacity(0.75), BlendMode.srcOver))
                  : null,
    ...
    Widget recommended(
        String type, List<String> following, List<Account> accs) {
      return Container(
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  ...accs.map(
                      (e) => accountInfo(e, type, following.contains(e.uid)))
                ],
              ),
            )
          ],
                  ...
                  child: Column(
                    children: [
                      TextField(
                        ...
                        onSubmitted: (value) =>
                            GoRouter.of(context).push("/search", extra: value),
                      ),
                      const SizedBox(height: 12),
                      Container(
                        width: double.infinity,
                        ...
                        child: Column(
                          children: [
                            if (collegeFeed.recommended.isNotEmpty)
                              recommended("College", user.following,
                                  collegeFeed.recommended),
                            ...collegeFeed.posts.map((e) => PostWidget(
                                post: e,
                                uid: uid,
                                type: "College",
                                authUserId: uid)),
                        ...
                        child: Column(
                          children: [
                            if (studentFeed.recommended.isNotEmpty)
                              recommended("Student", user.following,
                                  studentFeed.recommended),
                            ...studentFeed.posts.map((e) => PostWidget(
                                post: e,
                                uid: uid,
                                type: "Student",
                                authUserId: uid)),
                        ...
                        child: Column(
                          children: [
                            if (companyFeed.recommended.isNotEmpty)
                              recommended("Company", user.following,
                                  companyFeed.recommended),
                            ...companyFeed.posts.map((e) => PostWidget(
                                post: e,
                                uid: uid,
                                type: "Company",
                                authUserId: uid)),
