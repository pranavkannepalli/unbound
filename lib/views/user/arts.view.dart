  ...
  Widget build(BuildContext context) {
        ...
        child: (Row(
          children: [
            Text(e.place.contains("#") ? e.place : "#${e.place}",
                style: Theme.of(context).textTheme.titleLarge!.copyWith(color: pink.shade400)),
    ...
    Widget createArt(Art a) {
      return Column(
        ...
        children: [
          Text(a.years, style: Theme.of(context).textTheme.labelSmall!.copyWith(color: pink.shade400)),
          Text(a.name, style: Theme.of(context).textTheme.labelLarge!.copyWith(color: white.shade900)),
          const SizedBox(height: 6),
          Text(a.description, style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: white.shade800)),
          const SizedBox(height: 6),
          GestureDetector(
            onTap: () {
          ...
          Theme(
            ...
            child: ExpansionTile(
                ...
                children: a.accomplishments.map((e) => createAccomplishment(e)).toList()),
          ),
        ],
      );
    }
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text("Arts & Humanities", style: Theme.of(context).textTheme.displaySmall),
