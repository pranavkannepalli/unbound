...
class Review {
  ...
  Review({required this.name, required this.classOf, required this.stars, required this.text, required this.photo});
...
class Organization {
  ...
  Organization({required this.photo, required this.name, required this.members, required this.link});
}
...
class ApplicationInfo {
  ...
  ApplicationInfo({required this.earlyDecision, required this.regularDecision, required this.transfer, required this.link});
...
class Highlight {
  ...
  Highlight({required this.number, required this.name, required this.source, required this.date, required this.link});
